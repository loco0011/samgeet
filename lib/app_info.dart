...
const kSourceCodeUrl = 'https://github.com/loco0011/samgeet';
const kCopyright = '© 2026 Sambit Maity';
const kLicenseName = 'MIT License';

/// Where the app looks for a newer version (the latest GitHub release).
const kLatestReleaseApi = 'https://api.github.com/repos/loco0011/samgeet/releases/latest';
